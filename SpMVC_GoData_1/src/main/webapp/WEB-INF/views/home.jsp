...
<link rel="stylesheet" 
		href="${rootPath}/static/css/station.css?ver=2020-12-10-02"/>
<link rel="styleSheet" href="${rootPath}/static/css/pet.css?ver=2020-12-10-2" />
<script>
	document
			.addEventListener(
					"DOMContentLoaded",
					function() {
						...
						select_cat.onchange = function(e) {
							...
							if (value === 'hosp') {
								...
								document.querySelector("input[name='search']").placeholder = '주소 입력후 enter...'
							}
						}
					})
</script>
		...
		<ul>
			...
			<li>
				<form action="${rootPath}/bis/station">
					<input name="station" type="search"
