...
public class emsController {
   ...
   public String home(Locale locale, Model model) {
     ...
     List<EmsVO> emsList = emsService.seleAll();
   ...
   //public String write(String from_email, String to_email, String s_subject,Model model, EmsVO emsVO) {
