...
public class GoPetVO {
		...
		private String apiSid;			//10	필수	39	데이터번호
		private String apiDongName;		//255	필수	메이동물메디컬센터	동물병원의 이름
		private String apiNewAddress;	//255	필수	전라북도 전주시 완산구 백제대로 218 (중화산동2가)	동물병원의 도로명주소
