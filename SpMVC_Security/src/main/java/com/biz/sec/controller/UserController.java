...
public class UserController {
	...
	public String mypage() {
		...
		// return "mypage" >> tiles mypage definition을 찾아 rendering
		return "user/mypage"; // >> tiles 의 user/* 찾고, *대신 mypage문자열을 전달하여 rendring
		...
		//	 attribute로 설정된 jsp 파일들을 loading 하여 layout.jap에 설정대로
		...
		// 1,2,3 모든 경우에 해당하지 않는 경우 404 오류를 response한다
	}
