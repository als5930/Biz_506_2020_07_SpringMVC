...
public class NaverController {
	...
	/*
	 * @RequestParam()
	 * Controller의 매개변수를 재 정의의 하는용도
	 * 만약 client에서 보내는 변수 이름과 Controller에서 사용하는 변수 이름을 다르게 하고싶으면
	 * @RequestParam(name="변수") String 내이름
	 * 
	 * client에서 해당 변수값을 빼먹고 전송했을때 오류를 최소화 하기위해서
	 * @RequestParam(name="내이름", required=false,defailtValue="홍길동") String 내이름
	 * 클라이언트에서 '내이름' 
	 */
