...
public class HelloRestController {
	...
	/*
	 * @Autowired
	 * Spring Framework 프로트에서 @Autowired으로 설정된 클래스들을 객체로 생성한
	 * 컨테이너가 있으며
	 * 
	 * 컨테이너에 저장된 객체를 찾아서 선언된 객체에 주입하여 초기화, 사용할수있도록 만들어준다
	...
	*/
	 ...
	 * Container에 저장되어있다
	 * 
	 * 다른클래스를 객체로 생성하여 사용이 필요한 곳이 있으면
