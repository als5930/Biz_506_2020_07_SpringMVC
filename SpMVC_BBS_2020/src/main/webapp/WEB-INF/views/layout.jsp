...
*{
	...
	/*
		body를 flex로 선언하고 content가 위치하는 Box에 flex값을 1로 선언하면
		화면에 가득찬 layout이 만들어진다
		html, body의 height를 100%로 설정해주어야한다
		overfliw: auto로 설정을 하면 내용이 가득찼을때 자동으로 scroll bar가 생성
	*/
	section#content{
		overflow:auto;
		flex: 1;
...
<%/*
	...
	여기에 name으로 설정된 부분에 tile.xml파일에서 지정한 jap파일이 부착된다
*/%>
